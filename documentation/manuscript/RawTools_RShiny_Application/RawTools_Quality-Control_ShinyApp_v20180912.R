  ...
  output$qc_plots = renderPlot({
    ...
    if (input$yaxis_radio == 1){
      ...
      if (input$qc_plot_id == 2) {
        minBorder = 0
        maxBorder = round(max(qc_data$TotalAnalysisTime, na.rm = TRUE) + (max(qc_data$TotalAnalysisTime, na.rm = TRUE)*0.1), 2) 
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$NumMs1Scans, na.rm = TRUE) + (max(qc_data$NumMs1Scans, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$NumMs2Scans, na.rm = TRUE) + (max(qc_data$NumMs2Scans, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$NumMs3Scans, na.rm = TRUE) + (max(qc_data$NumMs3Scans, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$Ms1ScanRate..s., na.rm = TRUE) + (max(qc_data$Ms1ScanRate..s., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$Ms2ScanRate..s., na.rm = TRUE) + (max(qc_data$Ms2ScanRate..s., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$Ms3ScanRate..s., na.rm = TRUE) + (max(qc_data$Ms3ScanRate..s., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MeanDutyCycle.s., na.rm = TRUE) + (max(qc_data$MeanDutyCycle.s., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MeanMs2TriggerRate..Ms1Scan., na.rm = TRUE) + (max(qc_data$MeanMs2TriggerRate..Ms1Scan., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(log10(qc_data$Ms1MedianSummedIntensity), na.rm = TRUE) + (max(log10(qc_data$Ms1MedianSummedIntensity), na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(log10(qc_data$Ms2MedianSummedIntensity), na.rm = TRUE) + (max(log10(qc_data$Ms2MedianSummedIntensity), na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(log10(qc_data$MedianPrecursorIntensity), na.rm = TRUE) + (max(log10(qc_data$MedianPrecursorIntensity), na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MedianMs2PeakFractionConsumingTop80PercentTotalIntensity, na.rm = TRUE) + (max(qc_data$MedianMs2PeakFractionConsumingTop80PercentTotalIntensity, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$EsiInstabilityFlags.count., na.rm = TRUE) + (max(qc_data$EsiInstabilityFlags.count., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MedianMassDrift.ppm., na.rm = TRUE) + (max(qc_data$MedianMassDrift.ppm., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$IdentificationRate.IDs.Ms2Scan., na.rm = TRUE) + (max(qc_data$IdentificationRate.IDs.Ms2Scan., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$DigestionEfficiency, na.rm = TRUE) + (max(qc_data$DigestionEfficiency, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MissedCleavageRate..PSM., na.rm = TRUE) + (max(qc_data$MissedCleavageRate..PSM., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$ModificationFrequencyAtNTerm, na.rm = TRUE) + (max(qc_data$ModificationFrequencyAtNTerm, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$ModificationFrequencyAtK, na.rm = TRUE) + (max(qc_data$ModificationFrequencyAtK, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$ModificationFrequencyAtX, na.rm = TRUE) + (max(qc_data$ModificationFrequencyAtX, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MedianMsFillTime.ms., na.rm = TRUE) + (max(qc_data$MedianMsFillTime.ms., na.rm = TRUE)*0.1), 2)
        intBorder = round((max(qc_data$MedianMsFillTime.ms., na.rm = TRUE) / 10), 5)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MedianMs2FillTime.ms., na.rm = TRUE) + (max(qc_data$MedianMs2FillTime.ms., na.rm = TRUE)*0.1), 2)
        intBorder = round((max(qc_data$MedianMs2FillTime.ms., na.rm = TRUE) / 10), 5)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$MedianMs3FillTime.ms., na.rm = TRUE) + (max(qc_data$MedianMs3FillTime.ms., na.rm = TRUE)*0.1), 2)
        intBorder = round((max(qc_data$MedianMs3FillTime.ms., na.rm = TRUE) / 10), 5)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$WidthAt10.H.s., na.rm = TRUE) + (max(qc_data$WidthAt10.H.s., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$WidthAt50.H.s., na.rm = TRUE) + (max(qc_data$WidthAt50.H.s., na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$AsymmetryAt10.H, na.rm = TRUE) + (max(qc_data$AsymmetryAt10.H, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$AsymmetryAt50.H, na.rm = TRUE) + (max(qc_data$AsymmetryAt50.H, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$PeakCapacity, na.rm = TRUE) + (max(qc_data$PeakCapacity, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$TimeBeforeFirstExceedanceOf10.MaxIntensity, na.rm = TRUE) + (max(qc_data$TimeBeforeFirstExceedanceOf10.MaxIntensity, na.rm = TRUE)*0.1), 2)
        intBorder = round((max(qc_data$TimeBeforeFirstExceedanceOf10.MaxIntensity, na.rm = TRUE) / 10), 5)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$TimeAfterLastExceedanceOf10.MaxIntensity, na.rm = TRUE) + (max(qc_data$TimeAfterLastExceedanceOf10.MaxIntensity, na.rm = TRUE)*0.1), 2)
        intBorder = round((max(qc_data$TimeAfterLastExceedanceOf10.MaxIntensity, na.rm = TRUE) / 10), 5)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$FractionOfRunAbove10.MaxIntensity, na.rm = TRUE) + (max(qc_data$FractionOfRunAbove10.MaxIntensity, na.rm = TRUE)*0.1), 2)
        intBorder = round((max(qc_data$FractionOfRunAbove10.MaxIntensity, na.rm = TRUE) / 10), 5)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$IdChargeRatio3to2, na.rm = TRUE) + (max(qc_data$IdChargeRatio3to2, na.rm = TRUE)*0.1), 2)
        ...
        minBorder = 0
        maxBorder = round(max(qc_data$IdChargeRatio4to2, na.rm = TRUE) + (max(qc_data$IdChargeRatio4to2, na.rm = TRUE)*0.1), 2)
